# -*- coding: utf-8 -*-
"""
  Slack bot experiment/leapfrog for use at CARTO to shave off those valuable seconds
  from every day tasks (e.g., getting the lat long of a city or address)

  Excellent Slackbot template from: 
    https://www.fullstackpython.com/blog/build-first-slack-bot-python.html

  API Keys are stored as envinronment variables: `export GMAPS_APIKEY="..."`
"""
...
available_commands = {EXAMPLE_COMMAND: ('do something', 
                 ...
                 'weather': ('weather location', 
                             ...
                             'will print current weather in new york city'),
                 'xkcd': ('xkcd [latest]', 
                          'xkcd', 
                 ...
                 'data_obs': ('data observatory: _coming_soon_',
                              '...',
                              'will print a data observatory measure at the ' \
                              'specified location')}
...
def get_weather(location):
    ...
    owm_req = 'http://api.openweathermap.org/data/2.5/weather?q={location}&APPID={APIKEY}'
...
## command handling (performs command requested)
